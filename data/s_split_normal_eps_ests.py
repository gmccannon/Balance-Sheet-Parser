...
# Prefix the column names in current with eps_current_
current_periods = current_periods.rename(columns={
    'consensus': 'eps_current_consensus',
    'recent': 'eps_current_recent',
    'count': 'eps_current_count',
    'high': 'eps_current_high',
    'low': 'eps_current_low',
    'year_ago': 'eps_current_year_ago'
})

# Prefix the column names in current with eps_current_
next_periods = next_periods.rename(columns={
    'consensus': 'eps_next_consensus',
    'recent': 'eps_next_recent',
    'count': 'eps_next_count',
    'high': 'eps_next_high',
    'low': 'eps_next_low',
    'year_ago': 'eps_next_year_ago'
})
...
current_periods.to_csv("1_eps_current.csv", index=False)
next_periods.to_csv("1_eps_next.csv", index=False)
